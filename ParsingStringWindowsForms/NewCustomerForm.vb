...
Public Class NewCustomerForm
    ...
    Private Sub Form1_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        ' Without this set the user must enter information from top to bottom control wise.
    ...
    End Sub
    Private Sub companyNameTextBox_Validating(sender As Object, e As CancelEventArgs) Handles companyNameTextBox.Validating
    ...
    ''' <param name="e"></param>
    Private Sub streetTextBox_Validating(sender As Object, e As CancelEventArgs) Handles streetTextBox.Validating
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub stateComboBox_Validating(sender As Object, e As CancelEventArgs) Handles stateComboBox.Validating
