...
Class MainWindow
    ''' <summary>
    ''' Pattern match for determining if a string can be represented as a integer
    ''' </summary>
    ...
    ''' <param name="e"></param>
    Private Sub AssertIntegerTextBox_OnPreviewTextInput(sender As Object, e As TextCompositionEventArgs)
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub IntegerOnlyTextBox_OnClick(sender As Object, e As RoutedEventArgs)
    ...
    End Sub
    ''' <summary>
    ''' In a real application the novice developer will not use assertion but instead
    ''' do the cast or use a try/catch rather than perform assertion first.
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub NoAssertionToCheckIfIntegerButton_OnClick(sender As Object, e As RoutedEventArgs)
        Try
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub tryParseAssertionButton_Click(sender As Object, e As RoutedEventArgs) _
        Handles tryParseAssertionButton.Click
